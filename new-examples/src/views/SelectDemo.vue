<template>
  ...
  <b-select
    ...
    clearable
  ></b-select>
  <p style="margin: 20px 0;">多选：</p>
  <b-select v-model="selected7" :options="options1" multiple></b-select>
</template>

<script lang="ts">
import { defineComponent, ref } from 'vue'
import type { Options } from 'bdsaas-ui/src/select/types'
